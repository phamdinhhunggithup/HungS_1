...
$(document).ready(function() {
	$(window).resize(function() {
		if($(window).width() < 1280 ) {
			$("div.zoom").attr('data-aos','min');
		} else $("div.zoom").attr('data-aos','zoom');
	});
	$(window).scroll(function() {
		// opening zoom
		...
		} else $("#opening div").removeClass('aos-animate');
		// top product zoom
		...
		} else $("#top-product div").removeClass('aos-animate');
		// relative zoom
		...
		} else $("section#category .item-box").removeClass('aos-animate');
	});
});
// ===== BACKTOP =====
$(document).ready(function() {
